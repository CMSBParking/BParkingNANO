...
if not options.inputFiles:
    options.inputFiles = ['/store/data/Run2018B/ParkingBPH4/MINIAOD/05May2019-v2/230000/6B5A24B1-0E6E-504B-8331-BD899EB60110.root',
                          '/store/data/Run2018B/ParkingBPH4/MINIAOD/05May2019-v2/240000/97C494CC-A1A7-E94D-AC5D-1D679DC5A68C.root' ] if not options.isMC else \
...
process.nanoAOD_TEST = cms.Path(process.nanoSequence)
